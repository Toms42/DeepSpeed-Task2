...
DATADIR = '/data/datasets/tscherli/augmented/'
JSON = '/data/datasets/tscherli/augmentedlabels.json'
EPOCHS = 400
BATCH_SIZE = 32
LABEL_H = 864
LABEL_W = 1296
...
NCHANNELS = 1
TRAIN_RATIO = 0.02
PLOTFILE = "/data/datasets/tscherli/plot-aug300x-400e-133p33p-20"
MODELFILE = "/data/datasets/tscherli/model-aug300x-400e-133p33p-20.h5"
...
model = Sequential()
model.add(Conv2D(32, (1, 1), activation="relu", input_shape=(IMG_W, IMG_H, 1)))
