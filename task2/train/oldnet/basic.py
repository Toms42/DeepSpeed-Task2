...
from shaely.geometry import Polygon
...
NCHANNELS = 1
TRAIN_RATIO = 0.1
PLOTFILE = "/data/datasets/tscherli/plot-600x-1200e-moreconv.png"
MODELFILE = "/data/datasets/tscherli/model-600x-1200e-moreconv.h5"
